...
const GooeyNav = ({
  ...
  const handleClick = (e, index) => {
    activateIndex(index, e.currentTarget);
  };
        ...
        >
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`rounded-full relative cursor-pointer flex items-center justify-center transition-[background-color_color_box-shadow] duration-300 ease shadow-[0_0_0.5px_1.5px_transparent] text-white font-bold ${
